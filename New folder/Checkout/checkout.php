            ...
            <form id="checkoutForm" novalidate>
                ...
                <div class="terms-group">
                    ...
                    <label for="termsCheckbox">
                        I agree to the <a href="/lookgood/New folder/Homepage/terms.php" target="_blank">Terms and Conditions</a> and
                        <a href="/lookgood/New folder/Homepage/terms.php#return-policy" target="_blank">Refund Policy</a>.
                    </label>
                </div>
