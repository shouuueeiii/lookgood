...
$team = [
  [
    ...
    'bio'     => 'Keeps the servers running and the data flowing. If it works and you can\'t see it, that\'s him.',
    'photo'   => '../Resources/Images/team/aarhon.jpg', // replace with actual path
  ],
  [
    'name'    => 'Edrian Sedrik Halili',
    'role'    => 'Back-End Developer',
    'bio'     => 'APIs, databases, and everything in between — he makes it scale.',
    'photo'   => '../Resources/Images/team/edrian.jpg',
  ],
  [
    'name'    => 'Pollyne Anne Bartolome',
    'role'    => 'Front-End Developer',
    'bio'     => 'Turns designs into pixel-perfect reality. If it looks good, she made it happen.',
    'photo'   => '../Resources/Images/team/pollyne.jpg',
  ],
  [
    'name'    => 'Erica Mae Ramirez',
    'role'    => 'Full Stack Developer',
    'bio'     => 'The reason everything feels smooth and intentional.',
    'photo'   => '../Resources/Images/team/erica.jpg',
  ],
];

$placeholder_base = 'https://picsum.photos/seed/'; // remove once real photos are added
$placeholder_seeds = [10, 20, 30, 40];
?>
...
<section class="team" id="team-section">
  ...
  <div class="team-grid">
    <?php foreach ($team as $i => $member): ?>
      <?php
        // Use real photo if file exists, otherwise fall back to placeholder
