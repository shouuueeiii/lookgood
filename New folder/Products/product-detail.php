...
<nav class="navbar" id="mainNav">
      ...
      <div class="product-detail-container">
        ...
        <div class="product-detail-info">
          ...
          <div class="shipping-info">
            <div class="shipping-item"><i class="fas fa-truck"></i><span><strong>Free Shipping</strong> on orders over
                ₱2,500</span></div>
  ...
  <footer class="footer">
    <div class="footer-top">
      ...
      <div class="footer-newsletter">
        ...
        <div class="newsletter-form"><input type="email" class="newsletter-input" placeholder="your@email.com"><button
            type="button" class="newsletter-btn">Subscribe</button></div>
        ...
        <div class="footer-contact">
          ...
          <p><i class="fas fa-envelope"></i> lets@lookgood.ph</p>
  ...
  <script src="../../Actions/User/zoomImage.js"></script>
   <script src="../../Actions/User/index.js"></script>
    <script src="../../Actions/User/cart-standalone.js"></script>
    <script src="../../Actions/User/product-detail.js"></script>
</body>
