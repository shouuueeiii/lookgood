...
<nav class="navbar" id="mainNav">
  <div class="navbar-container">
    <a href="#top" class="navbar-logo">
      <img src="/lookgood/home/Resources/Logos/lookgood-black.png" alt="LookGood Frames" class="no-modal">
    </a>
    ...
    <div class="navbar-menu" id="navMenu">
      ...
      <ul class="navbar-nav">
        <li class="nav-item nav-item--dropdown">
          <a href="/lookgood/home/products-page.php" class="nav-link">Products</a>
          <div class="nav-dropdown">
            <div class="nav-dropdown-section">
              <a href="/lookgood/home/index.php#on-sale" class="nav-dropdown-link">On Sale!</a>
              <a href="/lookgood/home/index.php#best-sellers" class="nav-dropdown-link">Best Sellers</a>
            </div>
                <div class="nav-dropdown-divider"></div>
            <div class="nav-dropdown-section">
              <span class="nav-dropdown-label">Categories</span>
              <a href="/lookgood/home/products-page.php?filter=women" class="nav-dropdown-link">Frames for Women</a>
              <a href="/lookgood/home/products-page.php?filter=men" class="nav-dropdown-link">Frames for Men</a>
              <a href="/lookgood/home/products-page.php?filter=unisex" class="nav-dropdown-link">Unisex Frames</a>
            </div>
          </div>
        </li>
        ...
        <li class="nav-item"><a href="/lookgood/home/index.php#contact-section" class="nav-link">Contact</a></li>
                <li class="nav-item"><a href="/lookgood/home/index.php#faq" class="nav-link">FAQs</a></li>
        <li class="nav-item"><a href="/lookgood/home/index.php" class="nav-link">Home</a></li>
      </ul>
          ...
          <div class="nav-dropdown nav-dropdown--right">
            <?php if ($isLoggedIn): ?>
              ...
              <div class="nav-dropdown-section">
                ...
                <a href="/lookgood/home/myprofile.php" class="nav-dropdown-link">My Profile</a>
                <div class="nav-dropdown-divider"></div>
