  ...
  <div class="login-section">
    <div class="login-box" style="text-align: center;">
      ...
      <div class="contact-support">
        ...
        <span>Support: </span>
        <a href="mailto:bleubartolome@gmail.com" style="color:#d32f2f; text-decoration:none; font-weight:500;">lookgoodframes.ph@gmail.com</a>
      </div>

      <div class="action-buttons">
        <a href="user-login.php" class="btn-ban-primary"><i class="fas fa-sign-in-alt"></i> Back to Login</a>
        <a href="index.php" class="btn-ban-outline"><i class="fas fa-home"></i> Homepage</a>
      </div>
