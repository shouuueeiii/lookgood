...
<head>
    ...
    <link rel="stylesheet" href="/lookgood/css/User/forgot-password.css">
...
<div class="page">
    ...
    <div class="brand-section">
        <div class="brand-content">
            <a href="/lookgood/home/index.php">
                <img src="/lookgood/home/Resources/Logos/lookgood-black.png" class="brand-logo" alt="LookGood logo"
        ...
        <div class="login-box">
            ...
            <?php elseif ($step === 2): ?>
                ...
                <form method="POST" action="" style="display:inline;" id="resendForm">
                    <input type="hidden" name="action" value="send_otp">
                    <input type="hidden" name="email" value="<?= htmlspecialchars($email_input) ?>">
                    <button type="submit" class="link-btn" id="resendBtn" style="text-align: center;">Resend Code</button>
                </form></p>
...
<script src="/lookgood/userActions/forgot-password.js"></script>
<script>
