...
<head>
  ...
  <link rel="stylesheet" href="/lookgood/css/User/register.css">
  ...
  <div class="page">
    <div class="login-section">
      <div class="login-box">
        ...
        <div id="formStep">
          <form id="signupForm" novalidate>
            ...
            <div class="terms-group" style="padding: 0px 0; margin: 0px 0;">
              ...
              <label for="termsCheckbox" style="font-size: 11px;">
                I agree to the <a href="/lookgood/home/terms.php" target="_blank">Terms and Conditions</a>.
              </label>
            </div>

            <div id="formFeedback" class="feedback-msg"></div>

            <button type="submit" id="sendOtpBtn" class="loginbtn">Send Verification Code</button>
          </form>
          ...
          <a href="user-login.php" class="signup-link-btn">Log In</a>
        </div>
    ...
    <div class="brand-section">
      <div class="brand-content">
        <a href="/lookgood/home/index.php"><img src="/lookgood/home/Resources/Logos/lookgood-black.png" class="brand-logo"
            alt="LookGood logo"></a>
        <p class="brand-tagline">Looking good has never been this clear.</p>
      </div>
    </div>
  </div>
  <script src="/lookgood/userActions/user-signup.js?v=20260412a"></script>
</body>
</html>