...
<div class="team-grid">
  <?php foreach ($team as $member): ?>
    ...
    ?>
    <div class="team-card">
      <img class="team-card-img no-modal" src="<?= $photo ?>" alt="<?= htmlspecialchars($member['name']) ?>" loading="lazy" >
