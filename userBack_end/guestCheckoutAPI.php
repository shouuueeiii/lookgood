...
$conn->query("
    CREATE TABLE IF NOT EXISTS guest_checkout (
        ...
        guest_order_id   VARCHAR(40)  NULL,
...
// Add guest_order_id column to existing tables that predate this field
$conn->query("ALTER TABLE guest_checkout ADD COLUMN IF NOT EXISTS guest_order_id VARCHAR(40) NULL AFTER guest_id");
$conn->query("ALTER TABLE guest_checkout ADD UNIQUE INDEX IF NOT EXISTS uq_guest_order_id (guest_order_id)");
...
try {
    ...
    $status = 'pending';
    $insert->bind_param('sssdssssssds',
