document.addEventListener('DOMContentLoaded', function () {
    ...
    // Validate registration form (including phone and terms)
    function validateForm() {
        ...
        const termsChecked = document.getElementById('termsCheckbox').checked; // ADDED
    ...
    // STEP 1: Send OTP (with phone and terms)
        ...
        signupForm.addEventListener('submit', function (e) {
            ...
            requestJson('send_otp.php', {
                ...
                body: JSON.stringify({
                    ...
                    phone: document.getElementById('phone').value.trim(),   // ADDED
